...
# Run the LED Code
python ~/Downloads/PIGAME_TEST/raspberry_black_PI2/LED_Program.py &
...
# Run the LCD Code
python ~/Downloads/PIGAME_TEST/raspberry_black_PI2/lcd_animation.py & pids+=($!)
echo "lcd Program started"
sleep 1

# Run the LED Code
python ~/Downloads/PIGAME_TEST/raspberry_black_PI2/LED_Program.py & pids+=($!)
